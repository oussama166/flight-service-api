...
public interface AirportRepo extends JpaRepository<Airport, Long>, JpaSpecificationExecutor<Airport> {
  @Query(value = "select air from Airport air where air.location = :locationOrCode or air.code = :locationOrCode")
