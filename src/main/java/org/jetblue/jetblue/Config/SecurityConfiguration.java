...
public class SecurityConfiguration {
  ...
  @Bean
  public SecurityFilterChain config(HttpSecurity http, TokenImpl tokenImpl)
    throws Exception {
  ...
  @Bean
  JwtEncoder encoder() {
    JWK jwk = new RSAKey.Builder(rsakeyProps.publicKey())
      .privateKey(rsakeyProps.privateKey())
      .build();
