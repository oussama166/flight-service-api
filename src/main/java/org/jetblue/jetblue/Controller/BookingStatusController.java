...
public class BookingStatusController {
    ...
    public BookingStatusController(BookingStatusService bookingStatusService, BookingStatusRepo bookingStatusRepo) {
    ...
    public ResponseEntity<?> setBookingStatus(
        ...
        try {
            ...
            if (bookingStat == null) return ResponseEntity.ok("Can not create existent booking status!!!");
    ...
    public ResponseEntity<?> getStatusBooking(
        ...
        try {
            BookingStatus bookingStat = bookingStatusService.getBookingStatus(bookingStatus);

            if (bookingStat == null) return ResponseEntity.ok("Can not get booking status!!!");
            return ResponseEntity.ok(bookingStat);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(e);
        }
