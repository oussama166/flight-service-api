...
public class UserImpl implements UserService {
  ...
  @Override
  public UserResponseBasic findUserBasicByUsername(String username)
    throws Exception {
  ...
  public boolean updateUser(String username, UserUpdateRequest user) {
    ...
    if (userOpt == null) {
      ...
      userOpt.setFrequentFlyerNumber(
        String.valueOf(user.frequentFlyerNumber())
      );
  ...
  public User verifyUser(User user) throws Exception {
    ...
    userMailsService.sendUserVerificationMail(
      user,
