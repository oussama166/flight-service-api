...
public interface ReceiptMailService {
    ...
    void sendRefundRequestEmail(String to, String subject, User user, BookingPassenger bookingPassenger, Flight flight, Seat seat, double penalty,RefundUserRequest refundReq) throws MessagingException;
}
